...
import { sequencerDone } from "../funcs/sequencerDone.js";
import { sequencerHealth } from "../funcs/sequencerHealth.js";
...
export class Sequencer extends ClientSDK {
  ...
  async sequence(
    ...
    return unwrapAsync(sequencerSequence(
      this,
      request,
      options,
    ));
   ...
   */
  async done(
    request: components.DoneRequest,
    options?: RequestOptions,
  ): Promise<string> {
    return unwrapAsync(sequencerDone(
      this,
      request,
      options,
    ));
  ...
  async health(
    ...
    return unwrapAsync(sequencerHealth(
      this,
      options,
    ));
  }
  ...
  async openapiJson(
    ...
    return unwrapAsync(sequencerOpenapiJson(
      this,
      options,
    ));
  }
