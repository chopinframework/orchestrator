...
const args = {
  request: components.DoneRequest$inboundSchema,
};

export const tool$sequencerDone: ToolDefinition<typeof args> = {
  name: "sequencer_done",
  description: `Done operation
...
/// Handler to mark a domain's active request as done`,
  ...
  tool: async (client, args, ctx) => {
    const [result, apiCall] = await sequencerDone(
      client,
      args.request,
