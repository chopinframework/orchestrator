 ...
 */
export function oraclePostApiV1ContextMultipart(
  client: ChopinCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PostApiV1ContextMultipartRequestBody$outboundSchema.parse(
        value,
      ),
  ...
  const context = {
    ...
    operationID: "postApiV1Context_multipart",
    oAuth2Scopes: [],
