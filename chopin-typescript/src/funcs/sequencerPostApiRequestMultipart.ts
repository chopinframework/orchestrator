 ...
 */
export function sequencerPostApiRequestMultipart(
  client: ChopinCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PostApiRequestMultipartRequestBody$outboundSchema.parse(value),
  ...
  const context = {
    ...
    operationID: "postApiRequest_multipart",
    oAuth2Scopes: [],
