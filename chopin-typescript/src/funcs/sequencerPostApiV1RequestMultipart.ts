...
export enum PostApiV1RequestMultipartAcceptEnum {
...
export function sequencerPostApiV1RequestMultipart(
  ...
  Result<
    operations.PostApiV1RequestMultipartResponse,
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.PostApiV1RequestMultipartResponse$inboundSchema),
    M.bytes(200, operations.PostApiV1RequestMultipartResponse$inboundSchema, {
      ctype: "multipart/form-data",
    }),
    M.text(200, operations.PostApiV1RequestMultipartResponse$inboundSchema),
    M.bytes("*", operations.PostApiV1RequestMultipartResponse$inboundSchema, {
      ctype: "multipart/form-data",
    }),
    M.json("*", operations.PostApiV1RequestMultipartResponse$inboundSchema),
    M.text("*", operations.PostApiV1RequestMultipartResponse$inboundSchema),
