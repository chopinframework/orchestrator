...
<div align="left">
    <a href="https://www.speakeasy.com/?utm_source=@chopinframework/sdk&utm_campaign=typescript"><img src="https://custom-icon-badges.demolab.com/badge/-Built%20By%20Speakeasy-212015?style=for-the-badge&logoColor=FBE331&logo=speakeasy&labelColor=545454" /></a>
...
<br /><br />
> [!IMPORTANT]
> This SDK is not yet ready for production use. To complete setup please follow the steps outlined in your [workspace](https://app.speakeasy.com/org/chopin-framework/workspace). Delete this section before > publishing to a package manager.
...
## Table of Contents
<!-- $toc-max-depth=2 -->
* [@chopinframework/sdk](#chopinframeworksdk)
...
- Command:
```sh
npx -y --package @chopinframework/sdk -- mcp start --server-url ... --bearer-auth ... 
```
...
```sh
npx -y --package @chopinframework/sdk -- mcp start --help
```
...
const sdk = new Chopin({ httpClient });
```
...
const sdk = new Chopin({ debugLogger: console });
```

You can also enable a default debug logger by setting an environment variable `CHOPIN_DEBUG` to true.
<!-- End Debugging [debug] -->
...
### SDK Created by [Speakeasy](https://www.speakeasy.com/?utm_source=@chopinframework/sdk&utm_campaign=typescript)
